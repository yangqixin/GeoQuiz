...
public class QuizActivity extends AppCompatActivity {
    ...
    private Question[] mQuestionsBank =new Question[]{
            new Question(R.string.question_island,false),
            new Question(R.string.question_hot,true),
            new Question(R.string.question_river,false),
            new Question(R.string.question_city,true),
            new Question(R.string.question_mount,false),
    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mCheatButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
               boolean answerIsTrue =mQuestionsBank[mCurrentIndex].isAnswerTure();
